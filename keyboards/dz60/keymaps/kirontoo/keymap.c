...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_60_b_ansi(
        ...
        LT(_FN, KC_ESC), KC_A,    KC_R,     KC_S,    KC_T,    KC_D,     KC_H,     KC_N,     KC_E,     KC_I,     KC_O,        KC_QUOT,   KC_ENT,
    ...
    [_FL] = LAYOUT_60_b_ansi(
      ...
      ____,            ____,    ____,     KC_EQL,  KC_PLUS, ____,     ____,     KC_PMNS,  KC_UNDS,  ____,     ____,          ____,      ____,         ____,
      ____,            ____,    ____,     KC_LCBR, KC_RCBR, KC_AMPR,  KC_PIPE,  KC_LBRC,  KC_RBRC,  ____,     ____,          ____,      ____,
    ...
    [_KL] = LAYOUT_60_b_ansi(
      ...
      ____,            ____,    ____,     KC_CALC, VSCODE,  BLIZZ,    ____,     ____,     ____,     ____,     ____,          ____,      PSCR_MON,
